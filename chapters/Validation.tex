...
\par The user study was carried out over the first half of the Spring 2017 term at Cal Poly. 130 students signed up across 4 classes. By the end of the study, just over 3200 answers had been submitted to the application.
...
\par Interesting to note is that students who answered the questions in \textit{Polycommit} incorrectly scored worse on the actual midterm. This might indicate that students who simply answered questions to earn commitment did not have as good an understanding of scheduling as those who did. However, as noted above, the limitations of this study do not permit us to draw scientific conclusions from this data.
...
\begin{table}
	\begin{tabular}[h!]{ r c c }
		& \textbf{Polycommit Users} & \textbf{Polycommit Non-Users} \\
		\hline
		\textbf{Vector Math} & & \\
		Score & 98\% & 100\%  \\
	...
	\end{tabular}
\caption{Table representing the percentage score on the midterm for students who answered similar questions in \textit{Polycommit} for the class Introduction to Computer Graphics. NOTE: these midterm scores were self-reported, so their accuracy depends on the honesty of the reporting student.}
\end{table}
...
\begin{table}
	...
	\end{tabular}
\caption{Table representing the percentage score on the midterm for students who answered similar questions in \textit{Polycommit} for the class Introduction to Computer Networks. NOTE: these midterm scores were self-reported, so their accuracy depends on the honesty of the reporting student.}
\end{table}
